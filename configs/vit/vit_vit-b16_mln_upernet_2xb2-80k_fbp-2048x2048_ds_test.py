_base_ = [
    ...
    '../_base_/datasets/fbp_2048x2048_sp.py', 
...
model = dict(
    ...
    decode_head=dict(
        ...
        # pool_scales=( (2, 8), (4, 16), (6, 24), (8, 32) ),
...
train_cfg = dict(type='SPIterBasedTrainLoop', max_iters=40000, val_interval=2000)
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=500, 
                    max_keep_ckpts=10, save_best='mIoU'),
