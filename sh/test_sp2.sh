...
CUDA_VISIBLE_DEVICES=0,1 PORT=28000 tools/dist_train_ds.sh configs/vit/vit_vit-b16_mln_upernet_2xb2-80k_fbp-1024x1024_ds_test.py 2 --resume \
                        --work-dir work_dirs/exp_1114/vit_vit-b16_mln_upernet_2xb2-80k_fbp-1024x1024_ds_test


################################################ OKOK ################################################

# CUDA_VISIBLE_DEVICES=2,3 tools/dist_train_ds2.sh configs/vit/vit_vit-b16_mln_upernet_2xb2-80k_fbp-2048x2048_ds_test.py 2 --resume \
#                         --work-dir work_dirs/exp_1116/vit_vit-b16_mln_upernet_2xb2-80k_fbp-2048x2048_ds_test
