...
class MYMultiheadAttention(BaseModule):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False,
        ...
        self.dist_attn = DistributedAttention(F.scaled_dot_product_attention, _SEQUENCE_PARALLEL_GROUP, scatter_idx = 2, gather_idx = 1)  
...
# pad = _add_docstr(torch._C._nn.pad, """pad""")
...
def MYmulti_head_attention_forward(
    ...
    if need_weights:
        ...
        # attn_output = attn_output.permute(0, 2, 1, 3).contiguous().view(bsz * tgt_len, embed_dim)
...
class MYVisionTransformer_ds(BaseModule):
    """Vision Transformer.
